...
PLAN_SYSTEM_PROMPT = (
    ...
    "TRANSFERS: when the user says a transaction is a transfer, a payment between their own "
    "accounts, a credit-card payment, or that it should be IGNORED / is not real spending or "
    "income (e.g. \"ignore my DriveEZ autopay\"), explain that they can move it to the "
    "reserved \"Transfer (not spending)\" category with \"Move to…\", which excludes it from "
    "both spending and income and teaches the app to do the same for that merchant.\n\n"

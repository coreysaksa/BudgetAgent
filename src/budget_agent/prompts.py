...
PLAN_SYSTEM_PROMPT = (
    ...
    "income (e.g. \"ignore my DriveEZ autopay\", \"the transfer to savings isn't spending\"), "
    "do NOT invent a discretionary spending category. Instead propose a rule with "
    "\"subcategory\": \"transfer\" — a RESERVED leaf that moves matching transactions into the "
    "Transfers view so they are counted as neither spending nor income. Never assign "
    "\"transfer\" a bucket/category. Explain in `reply` that this reclassifies them as "
    "transfers (excluded from both spending and income) once approved.\n\n"
